...
<div class="dashboard">
	...
	<main class="content-wrap">
		<header class="content-head">
			<h1 style="margin-bottom:20px ;">DATA KARYAWAN</h1>
			<a href= "tambah_data.php">
				<button style="margin-bottom: 20px;" type="button" class="btn btn-warning">+Tambah Data</button>
			</a>	
			<!-- <div class="action">
				<button>
					Save search
					...
					<tbody>
						...
						while($row = $result->fetch_object()){
							echo '<tr>';
								...
								echo '<td>'.$row->nip.'</td>';
								echo '<td>'.$row->email_kar.'</td>';
								echo '<td>'.$row->no_hp.'</td>';
								echo '<td>'.$row->divisi_id.'</td>';
								echo '<td>'.$row->jabatan_id.'</td>';
								echo '<td>'.$row->stat_kar.'</td>';
								echo '<td>'.$row->tgl_msk.'</td>';
								echo '<td>'.$row->tgl_kontrakhabis.'</td>';
								echo '<td>
										<a class="btn btn-danger btn-sm" href="delete_karyawan.php?id=' . $row->id_karyawan . '">Delete</a>
									</td>';
							echo '</tr>';
							$i++;
						}
